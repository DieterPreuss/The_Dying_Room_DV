...
function _update()
 ...
 if(scene.running==false) then
 		...
 		ac=0.1 -- acceleration
			...
			collect_item()
	elseif(scene.number==-1 and btnp(🅾️)) then
			scene.xcounter=0
			scene.number = 0
			scene.timer = 5000
			scene.running=true
			
	elseif(scene.number==-1 and btnp(❎)) then
			shutdown()
	...
	elseif(scene.number==2 and scene.timer==0) then
				...
				del( wind, wind[1] )
				run()				
	elseif(scene.number==4 and scene.timer==0) then
				del( wind, wind[1] )
				scene.number = 6
				scene.timer = 5000
				scene.running=true
				scene.xcounter=0		
	elseif(scene.number==6 and scene.timer==0) then
				scene.xcounter=0
				del( wind, wind[1] )
				run()					
	end
...
function draw_scene(n)
	...
	if(n==-1) then
		...
		--blood----
		sspr( 40, 80, 16, 16, 0, 0, 32,32 )
		sspr( 56, 80, 16, 16, 98, 0, 32,32 )
		-----------
		print('z para empezar a sufrir', 16, 105,2)
		print('z para empezar a sufrir', 16, 104,8)
		--print('x para abandonar toda esperanza', 4, 116,2)
		-----------
	elseif(n==0) then     --initial scene
		...
		elseif(scene.xcounter==2) then
				del( wind, wind[1] )
				addwind(3*8-5, 12*8, 91, 30, scene0.dialog3.txt, "player")	
		elseif(scene.xcounter==3) then
				del( wind, wind[1] )
				addwind(3*8-5, 12*8, 91, 30, scene0.dialog4.txt, "player")	
		elseif(scene.xcounter==4) then
				del( wind, wind[1] )
				addwind(3*8-5, 12*8, 91, 30, scene0.dialog5.txt, "player")	
		elseif(scene.xcounter==5) then
				del( wind, wind[1] )
				map(112, 16, 0, 0, 16, 16)
				sspr( 0, 0, 64, 64, 32, 0, 64, 64 )
				sspr( 64, 0, 32, 32, 48, 64, 32, 38 )
				sspr( 96, 0, 12, 6, 54, 31, 24, 8 )
		elseif(scene.xcounter==6) then
				del( wind, wind[1] )
				scene.timer=1
		end 
		
	elseif(n==1) then     --boss1 entering scene
	...
	elseif(n==2) then --player death
		...
		elseif(boss.alive==false) then
			--blood----
				sspr( 40, 80, 16, 16, 0, 0, 32,32 )
				sspr( 56, 80, 16, 16, 98, 0, 32,32 )
				sspr( 40, 80, 16, 16, 33, 0, 32,32 )
				sspr( 56, 80, 16, 16, 66, 0, 32,32 )
			--helmet---
				sspr( 0, 80, 16, 16, 56, 60, 32, 32 )
			--spear----
				sspr( 80, 64, 16, 16, 72, 84, 24, 16 )
			-----------
				print('has muerto', 6*8-2, 104,2)
				print('presiona z para seguir sufriendo', 2*8-16, 116,2)
			--scene.timer=1
		end
	...
	elseif n==6 then --outro
		
		cls()
		if(scene.xcounter<1)then
			--texto--
			print('podra aleksandr', 0, 8,9)
			print('derrotar', 0, 17,2)
			print('al', 0, 24,9) 
			print('caballero oscuro', 10, 25,2)
			print('en su verdadera forma?', 0, 32,9)
			--detalles--
			print('derrotar', 0, 16,8)
			print('caballero oscuro', 10, 24,1)
		end
		
		if(scene.xcounter>=1)then
			--texto--
			print('gracias por jugar', 32, 9,8)
			print('este prototipo', 38, 17,8)
			print('esperamos que', 40, 25,8)
			print('lo hayas disfrutado',28, 33,8)
			--sombras--
			print('gracias por jugar', 32, 8,9)
			print('este prototipo', 38, 16,9)
			print('esperamos que', 40, 24,9)
			print('lo hayas disfrutado', 28, 32,9)
			--sombra--
			print('presiona x', 80, 117,8) 
			--texto--
			print('sinceramente,', 42, 49,8)
			print('facundo', 52, 57,11)
			print('y', 64, 65,8)
			print('dieter', 53, 73,1)
			--sombras--
			print('sinceramente,', 42, 48,9)
			print('facundo', 52, 56,3)
			print('y', 64, 64,9)
			print('dieter', 53, 72,8)
		end
		
		if(scene.xcounter==2)then
			scene.timer=1
		end
		print('presiona x', 80, 116,9) 
	end
	
	if((player.hp>0)and((scene.number!=-1)and(scene.number!=6))) print('presiona z para saltear', 2*8, 0*8)
...

...

...
__label__

...

...

...

...
__map__

...

__sfx__
